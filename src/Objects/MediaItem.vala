...
public class Lumiere.Objects.MediaItem : Object {
    ...
    construct {
        ...
        if (custom_poster_file.query_exists ()) {
            ...
            manager.thumbler.instant (uris, mimes, "large");
        }
    }
    ...
    private bool set_best_poster () {
        ...
        foreach (var poster_name in Lumiere.settings.get_strv ("poster-names")) {
