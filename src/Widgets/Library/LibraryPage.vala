...
public class Lumiere.LibraryPage : Gtk.Box {
    public signal void show_episodes (Objects.MediaItem item, bool setup_only = false);

    private Lumiere.Services.LibraryManager manager;
    ...
    construct {
        ...
        view_movies.add_css_class ("gridview");
        view_movies.add_css_class ("content-grid");
        ...
        manager = Lumiere.Services.LibraryManager.get_instance ();
    ...
    public Lumiere.Window.NavigationPage prepare_to_play (string file) {
